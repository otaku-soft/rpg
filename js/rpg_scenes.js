...
Scene_Battle.prototype.createTimerWindow = function() {
    var window = new Window_Selectable(0,0,500,100);
    var windowIndex  = 0;
    window.drawIcon(76, 0, 0);
    window.activate();
    window.hide();
    this.timerWindow = window;
    this.addChild(this.timerWindow); 
};
